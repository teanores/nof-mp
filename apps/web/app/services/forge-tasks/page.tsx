...
function forgeTasksOAuthStartHref(): string {
  const origin = process.env.NOF_TT_ORIGIN ?? process.env.NEXT_PUBLIC_NOF_TT_ORIGIN ?? "https://forge-tasks.forgath.ru";
    ...
    <PortalPageShell maxWidthClassName="max-w-4xl">
      ...
      <section className="panel grid gap-6 p-6 sm:p-8">
        <div className="flex flex-wrap gap-3">
          <Link className="tech-label rounded-sm border border-forge-accent bg-forge-accent px-5 py-3 text-xs text-black transition hover:border-forge-ink hover:bg-forge-ink" href={forgeTasksOAuthStartHref()}>
